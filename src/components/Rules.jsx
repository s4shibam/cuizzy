  ...
  return (
    ...
    >
      <span className='BG flex items-center'>
        <span className='icon material-symbols-outlined mr-2 text-2xl text-primary dark:text-secondary'>
          description
        </span>
        <span className='text text-xl font-semibold uppercase text-primary dark:text-secondary'>
          RULES
        </span>
        <span
          className={`icon material-symbols-outlined ml-auto text-3xl text-primary transition-transform duration-300 dark:text-secondary ${
            display && 'rotate-45'
          }`}
        >
          add
