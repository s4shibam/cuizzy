...
function DetailedReport({ qnaSet = [] }) {
  return (
    <div className='result-analytics mx-auto my-8 max-w-6xl'>
      ...
      {qnaSet.map((answer, index) => (
        <div
          className='question-set card pointer-events-none mb-10 select-none rounded-md p-3'
          key={index}
        >
          <div className='my-3 mb-3 flex items-center text-lg font-bold text-black dark:text-white sm:text-2xl'>
