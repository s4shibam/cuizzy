...
function DetailedSubmission() {
  ...
  return (
    <div className='about-page mx-auto flex w-[85%] animate-reveal flex-col items-center justify-center'>
      ...
      <h3 className='page-heading my-0 text-base font-semibold text-darkText dark:text-lightText sm:text-2xl'>
        Topic: {topicId.split('-').join(' ')}
      </h3>
      <h3 className='page-heading my-0 text-base font-semibold text-darkText dark:text-lightText sm:text-2xl'>
        Date: {date ? date : 'NA'}
      </h3>
      <h3 className='page-heading mt-0 text-base font-semibold text-darkText dark:text-lightText sm:text-2xl'>
        Time: {time ? time : 'NA'}
      </h3>
